...
colormap(gray)
ax1 = axes('Parent',f1);
imagesc([1 6],[1 5],HeatMapMatrixRNorm','Parent',ax1);
set(ax1,'XTick',[1 2 3 4 5 6],'YTick',[1 2 3 4 5],'YTickLabel',{'Depth Perception','Bimanual Dexterity',...
'Efficiency','Force Sensitivity','Robotic Control'},'XTickLabel',{'Time','Force','Acceleration','Orientation',...
...
colormap(gray)
ax2 = axes('Parent',f2);
imagesc([1 6],[1 5],HeatMapMatrixCNorm','Parent',ax2)
set(ax2,'XTick',[1 2 3 4 5 6],'YTick',[1 2 3 4 5],'YTickLabel',{'Depth Perception','Bimanual Dexterity',...
'Efficiency','Force Sensitivity','Robotic Control'},'XTickLabel',{'Time','Force','Acceleration','Orientation',...
'Velocity','Product'},'XTickLabelRotation',45,'YDir','reverse')
colorbar
